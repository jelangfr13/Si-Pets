...
$nameError = $emailError = $passError = $confirmPassError = "";
...
if (isset($_POST['btn-signup'])) {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $query = "SELECT userEmail FROM adopsi_binatang.users WHERE userEmail='$email'";
    ...
    if (!$error) {
        $query = "INSERT INTO adopsi_binatang.users(userName,userEmail,userPass) VALUES('$name','$email','$password')";
