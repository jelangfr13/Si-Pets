    ...
    <div class="col-md-10 pt-4 mx-auto">
        <div class="row ml-3 mt-5">
            ...
            if ($_POST) {
                ...
                $sql = "INSERT INTO adopsi_binatang.animals (name, date_of_birth, image, size, type, location, gender, description, hobbies) 
                        VALUES ('$name', '$date_of_birth', '$basename', '$size', '$type', '$location', '$gender', '$description', '$hobbies')";

                if (mysqli_query($conn, $sql)) {
                    echo "<div class=\"col-md-8\">
                    <h3 class='text-success'>Entry successfully added!</h3>
