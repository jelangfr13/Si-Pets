...
// Set loggedIn based on any logged-in status
...
if (isset($_POST['btn-login'])) {
    ...
    if (!$error) {
        ...
        $res = mysqli_query($conn, "SELECT id as userId, userName, userPass, status FROM adopsi_binatang.users WHERE userEmail='$email'");
